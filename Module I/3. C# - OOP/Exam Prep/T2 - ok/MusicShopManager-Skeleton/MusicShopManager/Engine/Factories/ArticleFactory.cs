namespace MusicShopManager.Engine.Factories
{
    ...
    public class ArticleFactory : IArticleFactory
    {
        ...
        {
            return new ElectricGuitar(make, model, price, color, true, bodyWood, fingerboardWood, numberOfAdapters, numberOfFrets);
        }
        ...
        {
            return new AcousticGuitar(make, model, price, color, false, bodyWood, fingerboardWood, caseIncluded, stringMaterial);
        }
        ...
        {
            return new BaseGuitar(make, model, price, color, true, bodyWood, fingerboardWood);
        }
    }
}
